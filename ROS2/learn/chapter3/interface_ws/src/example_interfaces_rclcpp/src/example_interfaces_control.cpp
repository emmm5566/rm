...
public:
    // 构造函数
	ExampleInterfacesControl(const std::string& node_name) : Node(node_name)
	{
        ...
        /*订阅机器人状态话题*/
        robot_status_subscribe_ = this->create_subscription<example_ros2_interfaces::msg::RobotStatus>("robot_status", 10,
...
//以先后顺序编译了example_ros2_interfaces再编译example_interfaces_rclcpp