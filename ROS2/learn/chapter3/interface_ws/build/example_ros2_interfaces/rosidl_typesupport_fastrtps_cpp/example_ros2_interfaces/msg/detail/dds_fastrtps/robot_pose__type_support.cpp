...
#include "example_ros2_interfaces/msg/detail/robot_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const example_ros2_interfaces::msg::RobotPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_ros2_interfaces::msg::RobotPose & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = example_ros2_interfaces::msg::RobotPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const example_ros2_interfaces::msg::RobotPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_ros2_interfaces::msg::RobotPose *>(
    untyped_ros_message);
...
{
  return &example_ros2_interfaces::msg::typesupport_fastrtps_cpp::_RobotPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_ros2_interfaces, msg, RobotPose)() {
  return &example_ros2_interfaces::msg::typesupport_fastrtps_cpp::_RobotPose__handle;
}
