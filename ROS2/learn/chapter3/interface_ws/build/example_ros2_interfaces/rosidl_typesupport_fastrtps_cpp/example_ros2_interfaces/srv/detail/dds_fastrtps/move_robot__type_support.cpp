...
#include "example_ros2_interfaces/srv/detail/move_robot__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = example_ros2_interfaces::srv::MoveRobot_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const example_ros2_interfaces::srv::MoveRobot_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_ros2_interfaces::srv::MoveRobot_Request *>(
    untyped_ros_message);
...
{
  return &example_ros2_interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_ros2_interfaces::srv::MoveRobot_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const example_ros2_interfaces::srv::MoveRobot_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<example_ros2_interfaces::srv::MoveRobot_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &example_ros2_interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot_Response__handle;
}
...
{
  return &example_ros2_interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot__handle;
}
